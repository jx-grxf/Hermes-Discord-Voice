...
- Anyone allowed to invoke the bot can trigger local transcription, local TTS generation, and a local `hermes` CLI call on the host machine.
...
- Review the security posture of the local Hermes environment separately from this bridge
